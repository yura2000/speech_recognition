    ...
    public void onMethodCall(MethodCall call, Result result) {
        switch (call.method) {
            case "speech.activate":
                ...
                Log.d(LOG_TAG, "Current Locale : " + "en_US");
                speechChannel.invokeMethod("speech.onCurrentLocale", "en_US");
                result.success(true);
                break;
            case "speech.listen":
...
//        speechChannel.invokeMethod("speech.onConfidenceLevel", confidenceLevel);
    }
    ...
    private void sendConfidenceLevel() {
        speechChannel.invokeMethod("speech.onConfidenceLevel", confidenceLevel);
    }
