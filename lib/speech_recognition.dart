...
typedef void DoubleResultHandler(double num);
...
class SpeechRecognition {
  ...
  DoubleResultHandler confidenceLevelHandler;
  ...
  /// start listening
  Future listen({String wordToLearn}) =>
      _channel.invokeMethod("speech.listen", wordToLearn);
  ...
  Future _platformCallHandler(MethodCall call) async {
    ...
    switch (call.method) {
      ...
      case "speech.onRecognitionComplete":
        ...
        break;
      case "speech.onConfidenceLevel":
        confidenceLevelHandler(call.arguments);
        break;
      case "speech.onError":
        errorHandler();
        break;
  ...
  // define a method to handle confidence level
  void setConfidenceLevelHandler(DoubleResultHandler handler) =>
      confidenceLevelHandler = handler;
